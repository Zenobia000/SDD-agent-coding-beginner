...
1. AGENTS.md（你的工作守則）
2. .agents/WORKFLOW.md（Vibe Engineering Sprint 十站總圖）
3. docs/PRD.md（我的需求規格，可能還沒填完）

讀完後，請跑 Vibe Engineering 第一站 /spec-it：
...
| 這句話 | 在做什麼 |
|---|---|
| 「請先讀 AGENTS.md / WORKFLOW.md」 | 強迫 AI 對齊工作守則與 Vibe Engineering 十站流程 |
| 「跑 /spec-it」 | Vibe Engineering 第一站：把模糊意圖結構化成 spec，後面 TDD 才有對齊基準 |
