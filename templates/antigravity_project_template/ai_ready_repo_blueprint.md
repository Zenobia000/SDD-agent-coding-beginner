...
> **與 USAGE.md 的關係**：USAGE.md 是給人看的 Vibe Engineering Sprint 使用說明（walkthrough + 陷阱 + FAQ）；WORKFLOW.md 是給 AI 看的十站流程定義（每站產出 + skill 對應）。
...
2. **打開 `USAGE.md`** 看 Vibe Engineering Sprint 十站怎麼跑（含完整 walkthrough）
