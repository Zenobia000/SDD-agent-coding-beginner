...
> Antigravity 開啟此專案時會自動讀這個檔案。這是「站立規則」，每次對話都生效。
...
2. `.antigravity/rules/01-keep-it-simple.md` — 簡單第一原則
3. `.antigravity/rules/02-coding-style.md` — code 風格
4. `.antigravity/rules/03-when-stuck.md` — 卡關 SOP
...
- ❌ 不要在使用者沒同意前裝任何套件（npm install / pip install）
