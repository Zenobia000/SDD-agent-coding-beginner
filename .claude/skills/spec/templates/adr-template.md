...
- 免費額度要足夠跑 50+ 次測試
- 文件對中文友善
- 與 Claude Code / Gemini CLI 生態原生整合
...
理由：Google AI Studio 註冊一鍵搞定（GoogleID 即可），免費額度大，與本工作坊主軸 Claude Code 同生態。

### Consequences
**好處：** 入門摩擦最低、與 Claude Code 零接縫整合
