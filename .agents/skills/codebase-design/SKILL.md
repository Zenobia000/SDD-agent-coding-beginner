...
4. 需要重要新 interface 時使用 [DESIGN-IT-TWICE.md](./references/DESIGN-IT-TWICE.md)，比較至少兩個根本不同方案。
5. 重構 cluster 時使用 [DEEPENING.md](./references/DEEPENING.md)，replace 而非在舊層上再加一層。
