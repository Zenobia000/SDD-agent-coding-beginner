...
| 怎麼做（完整版） | [`../../templates/VIBE_ENGINEERING_RUNBOOK.md`](../../templates/VIBE_ENGINEERING_RUNBOOK.md) | 8 階段從痛點到可運行 App |
| 怎麼做（快速版） | [`../../templates/MVP_RUNBOOK.md`](../../templates/MVP_RUNBOOK.md) | 填空式 MVP 模板 |
| 自動化執行 | [`../../templates/antigravity_project_template/.agents/`](../../templates/antigravity_project_template/.agents/) | Agent 規則與 skills |
